...
#include "agv_mapping_with_knowns_poses/mapping_with_knowns_poses.h"
...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<agv_mapping_with_knowns_poses::MappingWithKnownPoses>("mapping_with_knowns_poses");
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}
